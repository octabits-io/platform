/**
 * @octabits-io/drizzle-toolkit/config — a generic **config store** over any
 ...
 *   - {@link ConfigCipher}   — injected raw-string encrypt/decrypt (drizzle-toolkit
 *                              must NOT gain a `pii` dependency)
 ...
 * callback so drizzle-toolkit never depends on `@octabits-io/pii`.
 */
...
/**
 * Structural LRU-cache seam — satisfied by a `@octabits-io/foundation/utils`
