/**
 * @octabits-io/drizzle-toolkit/scoped-key-store — the Drizzle adapter behind
 * `@octabits-io/pii`'s structural `ScopedKeyStore` seam.
 *
 * `@octabits-io/pii` owns the encryption logic but knows nothing about SQL,
 ...
 * no import) — the same decoupling `@octabits-io/drizzle-toolkit/config` uses
 ...
 * don't hide the code. Moved here from `@octabits-io/pii` — the SQLSTATE is an
