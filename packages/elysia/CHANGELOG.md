...
- [`c4de746`](https://github.com/octabits-io/platform/commit/c4de746634cb164c51580ae16fd2cee2100941b2) - Fix consumer declaration-emit breakage introduced by the 0.7.1 tsdown/TS7 rebuild: declare `@sinclair/typebox` as a direct dependency (same `>= 0.34.0 < 1` range elysia itself uses) so the dts bundler keeps its types **external** (`import("@sinclair/typebox").…`) instead of inlining them as non-exported interfaces.
