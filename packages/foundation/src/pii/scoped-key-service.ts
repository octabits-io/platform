 ...
 * `@octabits-io/foundation/pii` needs no ORM peer — the Postgres/Drizzle implementation
 * lives in
 * [`@octabits-io/foundation/drizzle/scoped-key-store`](../drizzle/scoped-key-store)
