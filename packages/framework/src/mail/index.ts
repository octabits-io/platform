// ============================================================================
// @octabits-io/framework/mail — provider-agnostic mail transport contract
// ============================================================================
//
// The root entry is vendor-free (no mail-provider SDKs), but not
// dependency-free: it uses `@octabits-io/framework` (Result/Logger) at
...
//
//   @octabits-io/framework/mail/smtp     — nodemailer   (optional peer: nodemailer)
//   @octabits-io/framework/mail/mailjet  — node-mailjet (optional peer: node-mailjet)
//   @octabits-io/framework/mail/brevo    — wretch       (optional peer: wretch)
